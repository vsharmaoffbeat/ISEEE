        ...
        function drag(event) {
            ...
            if (_dnd.createClone) {
                if (!_dnd.clone) {
                    ...
                    //Custom Modification In puglin
                    if ($(createClone(_dnd.sourceEl)).data("type")) {
                        _dnd.clone.querySelector("i").setAttribute("class", $(createClone(_dnd.sourceEl)).data("type"));
                    }
                    //Custom Modification In puglin Ends
